      ...
      <div className="flex flex-wrap gap-8 bg-main justify-evenly ">
          ...
          {projects.map((project, index) => (
              ...
              <Link href="https://github.com/larbi1512"
                  target="_blank"
              rel="noopener noreferrer" className="bg-main_purple_dark rounded-2xl px-[2%] py-[1%] flex flex-row font-fira font-semibold text-[20px] mt-4 gap-4 items-center hover:bg-main_purple_darker">
